...
export function Footer() {
  ...
  return (
    <footer className="relative border-t-2 border-ocean-800/25 dark:border-t dark:border-ocean-800/20 bg-gradient-to-b from-background to-ocean-100/60 dark:to-ocean-950/40">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 md:py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="pt-8 border-t-2 border-ocean-800/20 dark:border-t dark:border-ocean-800/20 flex flex-col sm:flex-row justify-between items-center gap-4"
          >
